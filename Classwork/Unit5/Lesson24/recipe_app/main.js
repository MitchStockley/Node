...
passport.use(User.createStrategy());//Configuring the users login strategy
passport.serializeUser(User.serializeUser()); //set up passport to serialize and de serialize your user data
